    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        <h3 class="card-title font-16 mt-0">Form Add Mahasiswa</h3>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-responsive nowrap">
                                    ...
                                    <tbody id="tbody-data-siswa">
                                        <tr>
                                            <td><input type="text" name="nim[]" placeholder="Nomor Induk Mahasiswa" style="border: none; background: transparent; text-align: center;" autocomplete="off" minlength="10" maxlength="10" required></td>
