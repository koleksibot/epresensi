...
class Pdf extends CI_Controller
{
    ...
    public function absensi($data)
    {
        ...
        <table border="0" width="100%" style="vertical-align: bottom; font-family: serif; 
            ...
            <tr border="0">
                ...
                <td width="33%" style="text-align: right; border: none;">E-Presensi by PPAK FMIPA 2021</td>
            </tr>
        ...
        <table border="0" width="100%" style="vertical-align: bottom; font-family: serif; 
            ...
            <tr border="0">
                <td width="33%"><span style="font-weight: bold; font-style: italic;">E-Presensi By PPAK FMIPA 2021/span></td>
        ...
        $html = '
            ...
            <body>
            <h2 style="text-align: center;">E-PRESENSI BY PPAK FMIPA 2021<br><small>Built With Codeignite 3 & PHP 7</small></h2>
                <p style="text-align: center;">Edited by Panitia PPAK FMIPA 2021</p>
                <hr>
                <center>
    ...
    public function exportqr($data)
    {
        ...
        $html = '
            ...
            <body>
                <h2 style="text-align: center;">E-PRESENSI BY PPAK FMIPA 2021<br><small>Built With Codeignite 3 & PHP 7</small></h2>
                <p style="text-align: center;">Edited by Alfandi</p>
                <hr>
                <p style="text-align: center; font-weight: bold;">QR Code Presensi ' . $event->nama_event . '</p>
                <div style="margin-left: 150px;">
                    <img src="' . 'http://punyapandi.my.id/epresensi/assets/app-assets/qr/img/' . $event->qr_event . '" alt="Gambar Qr">
                </div>
            </body>
            </html>';
